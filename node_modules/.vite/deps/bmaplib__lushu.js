...
// node_modules/bmaplib.lushu/index.js
var require_bmaplib = __commonJS({
  "node_modules/bmaplib.lushu/index.js"(exports, module) {
      ...
      baidu.object.extend(LuShu.prototype, {
        ...
        _pauseForView: function(index) {
          ...
          var t = setTimeout(function() {
            me._moveNext(++me.i);
          }, me._opts.landmarkPois[index].pauseTime * 1e3);
      ...
      function initCustomOverlay() {
        ...
        baidu.object.extend(CustomOverlay.prototype, {
          setPosition: function(poi, markerSize) {
            var px = this._map.pointToOverlayPixel(poi), styleW = baidu.dom.getStyle(this._div, "width"), styleH = baidu.dom.getStyle(this._div, "height"), overlayW = parseInt(this._div.clientWidth || styleW, 10), overlayH = parseInt(this._div.clientHeight || styleH, 10);
...
//# sourceMappingURL=bmaplib__lushu.js.map
