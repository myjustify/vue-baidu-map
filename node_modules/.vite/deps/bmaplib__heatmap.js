...
// node_modules/bmaplib.heatmap/index.js
var require_bmaplib = __commonJS({
  "node_modules/bmaplib.heatmap/index.js"(exports, module) {
    (function(root, factory) {
      ...
      var heatmapFactory = function() {
        ...
        var legend = function legend2(config) {
          this.config = config;
          var _ = {
            element: null,
            labelsEl: null,
        ...
        legend.prototype = {
          init: function() {
            var me = this, config = me.config, title = config.title || "Legend", position = config.position, offset = config.offset || 10, gconfig = config.gradient, labelsEl = document.createElement("ul"), labelsHtml = "", grad, element, gradient, positionCss = "";
        ...
        var heatmap = function heatmap2(config) {
          var _ = {
            radius: 40,
            element: {},
            canvas: {},
        ...
        heatmap.prototype = {
          configure: function(config) {
            ...
            me.set("gradient", config.gradient || { 0.45: "rgb(0,0,255)", 0.55: "rgb(0,255,255)", 0.65: "rgb(0,255,0)", 0.95: "yellow", 1: "rgb(255,0,0)" });
          ...
          drawAlpha: function(x, y, count, colorize) {
            var me = this, radius = me.get("radius"), ctx = me.get("actx"), max = me.get("max"), bounds = me.get("bounds"), xb = x - 1.5 * radius >> 0, yb = y - 1.5 * radius >> 0, xc = x + 1.5 * radius >> 0, yc = y + 1.5 * radius >> 0;
...
//# sourceMappingURL=bmaplib__heatmap.js.map
